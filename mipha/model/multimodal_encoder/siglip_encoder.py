...
class SiglipVisionTower(SiglipPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.text_module_path = getattr(config, 'model_name_or_path', None)
    ...
    def load_text_modules(self):
        ...
        if self.text_module_path and os.path.exists(os.path.join(self.text_module_path, 
                                                                 'vision_tower.bin')):
            try:
                ...
                print(self.image_text_infusion)
                ...
                print(f'Text modules were loaded successfully on gpu {self.device}!')
            except Exception as e:
                print(e)
                print(f'Text modules were not loaded on gpu {self.device}')
        else:
