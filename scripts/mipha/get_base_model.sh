...
## phi2
base_model_dir=./phi-2
outputdir=./ckpts/checkpoints-siglip/base_checkpoints/mipha_phi_2


$SCRATCH/code/llava-phi/pytorch-example/python mipha/train/convert_model2base_mipha.py \
    --model_name_or_path $base_model_dir \
    --version plain \
    --data_path /vast/sg7457/LLaVA-Pretrain/blip_laion_cc_sbu_558k.json \
    --image_folder /vast/sg7457/LLaVA-Pretrain/images \
